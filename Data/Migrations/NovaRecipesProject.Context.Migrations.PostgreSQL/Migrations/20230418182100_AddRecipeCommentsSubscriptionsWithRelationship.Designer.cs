...
namespace NovaRecipesProject.Context.Migrations.PostgreSQL.Migrations
{
    ...
    [Migration("20230418182100_AddRecipeCommentsSubscriptionsWithRelationship")]
    partial class AddRecipeCommentsSubscriptionsWithRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NovaRecipesProject.Context.Entities.RecipeCommentsSubscription", b =>
                {
                    ...
                    b.HasIndex("SubscriberId", "RecipeId")
                        .IsUnique();
